...
- [ ] Fix `doc/13-examples.md` §8.9 and §8.10 TypeAssert AST examples showing fictional `resolved_type: None` field — same phantom field appears at lines 201-204 (§8.9) and 221-224 (§8.10). Remove from both examples. (`doc/13-examples.md:201-204, 221-224`) [Major, grammar-architect C40]
