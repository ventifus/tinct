...
**Key Files:**
- `src/builtins.rs` — Rust-native builtins (77 functions; see doc/11-stdlib.md for current count); includes `IncludeContext` with include result cache for memoization (prevents re-evaluation of included files).
